...
import { StyledBtnContainer, StyledContainer, StyledMenu, StyledMenuItem } from './SortBy.styled';
    ...
    return (
        <StyledContainer>
            <StyledBtnContainer
                ...
                onClick={handleClick}
                variant="text"
                startIcon={<Icons.SortBy height={13} width={13} fill={Theme.colors.primaryBlack} />}
            >
                Sort by
            </StyledBtnContainer>
            <StyledMenu
