...
function BannerDropWithUploadComponent({
  ...
  const [removeImage, setRemoveImage] = useState<boolean>(
    removeBrowseBannerImage
  );
    ...
    <StyledFileDropWithUploadMainSection>
      ...
      >
              ...
              >
                ...
                {labels.infoLabel && (
                  <p
                    className={
                      bannerError
                        ? "bannerError fileUploadAllowMsg"
                        : "fileUploadAllowMsg"
                    }
                  >
                    {labels.infoLabel}
        ...
        <input
          type="file"
          onChange={(event) =>
            onBannerChange(event.target.files, "uploadFile", event)
          }
          id="uploadBanner"
          hidden
      ...
      {shouldShowHint && labels.hintLabel && (
        <p className="hintPara">{labels.hintLabel}</p>
      )}
