...
export function useCharacterLimit(
    ...
    useEffect(() => {
        ...
        return mergeRegister(
            ...
            editor.registerRootListener(() => {
                const textLength = textLengthComputation(text, lastComputedTextLength);
    ...
    //Helper
    const textLengthComputation = (text: string, lastComputedTextLength: number): number => {
        const textStr = text.replace(/\n/g, '');
        const textLength = strlen(textStr);
