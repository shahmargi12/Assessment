...
export const getLoadingStyleAsPerVariantAndSize = (size: ButtonSizes): { size: number } => {
    return {
...
function ButtonComponent({
    ...
    const loadingStyle = useMemo(() => getLoadingStyleAsPerVariantAndSize(size), [variant, size]);
