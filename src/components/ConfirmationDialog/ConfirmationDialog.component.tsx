...
function ConfirmationDialog({
    ...
    return (
        <StyledDiv>
            <StyledModalContainer open={open} onClose={handleClose} width={width} height="auto">
                <div className="dialogContainer">
                    ...
                    <div className="btn">
                        <Button variant="contained" size="medium" disabled={disabled} onClick={handleOnConfirm}>
                            {text.okayText}
                        </Button>
