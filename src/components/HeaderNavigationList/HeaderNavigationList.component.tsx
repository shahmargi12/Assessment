...
const HeaderNavigationList = ({ menus, onClick }: HeaderNavigationListProps): JSX.Element => {
    const [hiddenClass, setHiddenClass] = useState<boolean>(false);

    const handleClick = (event: React.MouseEvent<HTMLButtonElement, MouseEvent>, menu: HeaderItem) => {
